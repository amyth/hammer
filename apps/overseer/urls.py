...
urlpatterns = [
    ...
    url(r'^get_normalized_matches/$', views.get_normalized_matches, name="get_normalized_matches"),
    ...
    # url(r'^search_form_submit/$', login_required(views.Index.search_form_submit()), name="search"),
    # url(r'^search_form_submit/$', views.search_form_submit, name="search"),
]